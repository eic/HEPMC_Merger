...
if __name__ == '__main__':
    ...
    #
    one_background_particle=args[0]
    ...
    for i in range(len(sig_cont)):
        ...
        sig_particles=[]
        sig_vertices=[]
        sig_time_shift=c_light*(args[2]*rd.random())
        ...
        if one_background_particle:
            back_time_shift=c_light*(args[2]*rd.random())
